...
from qt_to_qml import transpile_text, transpile_file  # noqa: E402


SAMPLE = '''
import { Button, VerticalBox, LineEdit } from "std-widgets.qml";
...
class QtToQmlTests(unittest.TestCase):
    def test_transpile_common_constructs(self):
        result = transpile_text(SAMPLE, "sample.qml")
