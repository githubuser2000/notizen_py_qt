...
Root: `/mnt/data/qt611_no_qt_migration_kit_v3`
...
### /mnt/data/qt611_no_qt_migration_kit_v3/examples/main_window.qml
...
### /mnt/data/qt611_no_qt_migration_kit_v3/examples/advanced_app.qml
...
The script writes `QT611_PYTHON_QT_MIGRATION_ACTIONS.md` and backs up overwritten files under `.qt611_no_qt_backup_v4/<timestamp>/`.
