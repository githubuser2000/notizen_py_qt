...
class StickyWindow:
    ...
    attributes on the note node.  Qt cannot recreate the exact WinForms
...
class NoteDocument:
    ...
    def find_detailed(
        ...
        *,
        ...
        CLI, tests and Qt status line. The optional ``start`` argument mirrors
    ...
    def find_occurrences(
        ...
        *,
        ...
        ``TreeNode`` and a RichTextBox ``SelectionStart``.  Qt does not expose
    ...
    def replace_all(
        ...
        *,
        ...
        This is the same compromise as the Qt text editor: it is portable and
