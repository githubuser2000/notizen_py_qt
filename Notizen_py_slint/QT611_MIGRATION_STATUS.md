...
- `.qt611_no_qt_backup_v4/20260429-212035/qml/AppWindow.qml:403: // TODO(qt611-port): changed text => { root.editorChanged(root.text); }`
- `.qt611_no_qt_backup_v4/20260429-212035/qml/Main.qml:403: // TODO(qt611-port): changed text => { root.editorChanged(root.text); }`
- `.qt611_no_qt_backup_v4/20260429-212035/qml/app-window_AppWindow.qml:488: // TODO(qt611-port): pointer-event(event) => {`
- `.qt611_no_qt_backup_v4/20260429-212035/qml/app-window_AppWindow.qml:694: // TODO(qt611-port): pointer-event(event) => {`
- `.qt611_no_qt_backup_v4/20260429-212035/qml/app-window_AppWindow.qml:711: // TODO(qt611-port): edited(text) => { root.editorChanged(text); }`
- `.qt611_no_qt_backup_v4/20260429-212035/qml/app-window_AppWindow.qml:739: // TODO(qt611-port): pointer-event(event) => {`
